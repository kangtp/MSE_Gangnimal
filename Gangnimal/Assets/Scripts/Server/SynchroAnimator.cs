...
{
     class NetworkAnimatorStateChangeHandler : INetworkUpdateSystem
    {
        ...
        /// </summary>
         void SendAnimationUpdate(NetworkAnimator.AnimationMessage animationMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        /// </summary>
         void SendParameterUpdate(NetworkAnimator.ParametersUpdateMessage parametersUpdateMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        private List<NetworkAnimator.ParametersUpdateMessage> m_ProcessParameterUpdates = new List<NetworkAnimator.ParametersUpdateMessage>();
         void ProcessParameterUpdate(NetworkAnimator.ParametersUpdateMessage parametersUpdateMessage)
        {
        ...
        /// </summary>
         void QueueTriggerUpdateToClient(NetworkAnimator.AnimationTriggerMessage animationTriggerMessage, ClientRpcParams clientRpcParams = default)
        {
         ...
         void QueueTriggerUpdateToServer(NetworkAnimator.AnimationTriggerMessage animationTriggerMessage)
        {
         ...
         void DeregisterUpdate()
        {
         ...
         NetworkAnimatorStateChangeHandler(NetworkAnimator networkAnimator)
        {
    ...
    public class NetworkAnimator : NetworkBehaviour, ISerializationCallbackReceiver
    {
        ...
        [HideInInspector]
        [SerializeField]
         List<TransitionStateinfo> TransitionStateInfoList;
        ...
        public void OnBeforeSerialize()
        {
         ...
         struct AnimationState : INetworkSerializable
        {
         ...
         struct AnimationMessage : INetworkSerializable
        {
         ...
         struct ParametersUpdateMessage : INetworkSerializable
        {
             byte[] Parameters;
            public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter
            {
         ...
         struct AnimationTriggerMessage : INetworkSerializable
        {
             int Hash;
             bool IsTriggerSet;
        ...
        /// </summary>
         List<AnimatorStateInfo> SynchronizationStateInfo;

        private unsafe struct AnimatorParamCache
        {
             int Hash;
             int Type;
             fixed byte Value[4]; // this is a max size of 4 bytes
        }
        ...
        {
             static readonly int AnimatorControllerParameterInt;
             static readonly int AnimatorControllerParameterFloat;
             static readonly int AnimatorControllerParameterBool;
             static readonly int AnimatorControllerParameterTriggerBool;
        ...
        /// </summary>
         AnimationMessage GetAnimationMessage()
        {
        ...
        /// </summary>
         unsafe void UpdateParameters(ref ParametersUpdateMessage parametersUpdate)
        {
        ...
        /// </summary>
        [ClientRpc]
         unsafe void SendParametersUpdateClientRpc(ParametersUpdateMessage parametersUpdate, ClientRpcParams clientRpcParams = default)
        {
        ...
        /// </summary>
        [ClientRpc]
         unsafe void SendAnimStateClientRpc(AnimationMessage animationMessage, ClientRpcParams clientRpcParams = default)
        {
        ...
        /// </summary>
        [ServerRpc]
         void SendAnimTriggerServerRpc(AnimationTriggerMessage animationTriggerMessage, ServerRpcParams serverRpcParams = default)
        {
        ...
        [ClientRpc]
         void SendAnimTriggerClientRpc(AnimationTriggerMessage animationTriggerMessage, ClientRpcParams clientRpcParams = default)
        {
            InternalSetTrigger(animationTriggerMessage.Hash, animationTriggerMessage.IsTriggerSet);
        }
